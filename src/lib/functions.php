...
function sideMenu()
{
    return [
        [
            ...
            'url' =>  Url::to(['default/content', 'id' => 'cms.contents.default.coaching.1']),
            'options' => ['class' => Yii::$app->request->getUrl() === '/meet-your-coach' ? 'active' : ''],

        ],
        [
            'label' => 'Coaching Services',
            'url' =>  Url::to(['default/content', 'id' => 'cms.contents.default.services.1']),
            'options' => ['class' => Yii::$app->request->getUrl() === '/services' ? 'active1' : ''],
        ],
        [
            'label' => 'Courses',
            'url' =>  Url::to(['default/contents', 'type' => 'courses']),
            'options' => ['class' => Yii::$app->request->getUrl() === '/course-page' ? 'active1' : ''],
        ],
        [
            'label' => 'Testimonials',
            'url' =>  Url::to(['default/contents', 'type' => 'testimonial']),
            'options' => ['class' => Yii::$app->request->getUrl() === '/client-testimonials' ? 'active1' : ''],
        ],
        [
            'label' => 'News & Events',
            'url' =>  Url::to(['default/contents', 'type' => 'news']),
            'options' => ['class' => Yii::$app->request->getUrl() === '/news-events' ? 'active1' : ''],

        ],
        [
            'label' => 'Get In Touch',
            'url' =>  Url::to(['default/contents', 'type' => 'contact']),
            'options' => ['class' => Yii::$app->request->getUrl() === '/contact-Us' ? 'active1' : ''],
